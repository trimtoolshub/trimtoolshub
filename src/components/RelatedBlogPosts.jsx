...
const RelatedBlogPosts = ({ currentPostId, limit = 3 }) => {
  const relatedPosts = getRelatedBlogPosts(currentPostId, limit)
  ...
  return (
    <section style={{ marginTop: '4rem' }}>
      <h2 style={{ 
        ...
        <FontAwesomeIcon icon="fas fa-book-open" style={{ marginRight: '0.5rem', color: 'var(--accent)' }} />
        Related Articles
      </h2>
